            ...
            <div className='flex-1 flex flex-col  gap-2.5 px-2 '>
                <div className='bg-[#e3f0ff] p-4 rounded-lg  ' >
                    ...
                    <div className='flex flex-col items-center gap-1 w-full'>
                        <button className='bg-blue-600 text-white py-2  w-full rounded-lg'>Join now</button>
                        <button className=' bg-white text-blue-600 py-2  w-full rounded-lg'>Log in</button>
                    </div>
                </div>
